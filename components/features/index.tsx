...
const Features = () => {
  return (
    <div className='flex flex-col-reverse'>
      <section className="py-10 sm:py-16 lg:py-20 rounded-lg">
        <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
          <div className="grid items-center grid-cols-1 gap-y-6 md:grid-cols-2 md:gap-x-20">
            ...
            <div className="relative pl-20 pr-6 sm:pl-6 md:px-0">
              <div className="relative w-full h-full flex1 mt-4 mb-10 ml-auto">
      ...
      <section className="py-10 sm:py-16 lg:py-20 -mt-16">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <h2 className="mt-8 text-3xl font-bold leading-tight text-black lg:mt-12 sm:text-4xl lg:text-5xl">Join <span className="border-b-8 border-yellow-300">1,247</span> other developers</h2>
